              ...
              <FormItem>
                ...
                <FormControl>
                  <ImageUpload
                    ...
                    onDelete={(url) => field.onChange(field.value.filter((prevUrl) => prevUrl !== url))}
                    disabled={loading}
                  />
                </FormControl>
                <FormMessage />
                  ...
                  <FormControl>
                    <div className="items-top flex space-x-2 border p-4 rounded-sm">
                      ...
                      <div className="flex flex-col gap-1.5 leading-none">
                        ...
                        <p className="text-sm text-muted-foreground">This product will appear in the home page.</p>
                      </div>
                    </div>
                  </FormControl>
                  <FormMessage />
