...
const graphData: Array<{ name: string; total: number }> = [
    { name: "Jan", total: 0 },
    { name: "Feb", total: 0 },
    { name: "Mar", total: 0 },
    { name: "Apr", total: 0 },
...
export default async function DashboardPage({ params }: { params: { storeId: string } }) {
    ...
    store.orders.forEach((order) => {
        if (order.isPaid) {
            ...
            graphData[monthCreated].total = Number(order.totalPrice);
        }
    });
            ...
            <div className="grid gap-4  md:grid-cols-2 lg:grid-cols-7">
                ...
                <div className="border p-6 flex-1 rounded-md space-y-8 col-span-3">
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm mt-1">You made 265 sales this month.</p>
                    </div>
